...
public class DataLoader implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        // ==========================================
        Lesson l1 = new Lesson("Constraint Programming",  t2,"BSCS Y4S2");
        Lesson l2 = new Lesson("Artificial Intelligence", t1,"BSCS Y4S2");
        Lesson l3 = new Lesson("Software Architecture", t1, "BSCS Y4S2");

        Lesson l4 = new Lesson("Network Administration", t3, "BIT Y3S1");
        Lesson l5 = new Lesson("Database Management Systems", t4, "BIT Y3S1");
        Lesson l6 = new Lesson("Web Systems Development", t3, "BIT Y3S1");

        lessonRepository.saveAll(List.of(l1, l2, l3, l4, l5, l6));
    }
